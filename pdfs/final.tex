...
\begin{figure}[ht]
  ...
  \caption{Quackle vs CS221 With Monte Carlo}
  \endminipage
  \minipage{0.5\textwidth}
      \centering
  \includegraphics[scale=0.4]{../images/quacklegame_rackH_100}\\
   \caption{This will be a game w/ montecarlo rH? }
  \endminipage{}
\end{figure}
\begin{figure}[h]
  \minipage{0.5\textwidth}
...
\begin{figure}[h]
  \minipage{0.5\textwidth}
    \centering
  \includegraphics[scale=0.4]{../images/quacklegame_vanilla_111}
  \caption{CS221 Vanilla vs CS221 Vanilla}
  \endminipage
  \minipage{0.5\textwidth}
      \centering
  \includegraphics[scale=0.4]{../images/quacklegame_rackH_111}\\
   \caption{CS221 Vanilla vs CS221 with Rack Heuristics}
  \endminipage{}
\end{figure}
...
\begin{figure}[h]
  \minipage{0.5\textwidth}
    \centering
  \includegraphics[scale=0.4]{../images/quacklegame_vanilla_111}
  \caption{Will be CS221 Vanilla vs CS221 with Monte Carlo}
  \endminipage
  \minipage{0.5\textwidth}
      \centering
  \includegraphics[scale=0.4]{../images/quacklegame_rackH_111}\\
   \caption{Will be CS221 Vanilla vs CS221 with Monte Carlo and rack heuristics}
  \endminipage{}
\end{figure}
