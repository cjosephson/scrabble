...
One of the most important publications in the history of scrabble AIs was a paper by Andrew Appel and Guy Jacobson published in 1988 on 'The World's Fastest Scrabble Program'. It in, Appel and Jacobson describe the search algorithm that has since been used by all major scrabble AIs, a simplified version of which we use in our implimentation 


Appel and Jacobsen, Maven, Quackle
